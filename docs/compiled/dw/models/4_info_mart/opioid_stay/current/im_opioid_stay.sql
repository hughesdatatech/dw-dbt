...
select
    ...
    'd7812065-58c0-4de0-9db4-f854c1b2d9ef' as im_opioid_stay_job_id,
    'circleci' as im_opioid_stay_job_user_id,
    jira_task_key as im_opioid_stay_jira_task_key,
    to_char(timestamp '2023-03-05 15:13:35.612072+00:00', 'YYYY-MM-DD HH24:MI:SS')::timestamp  as im_opioid_stay_extracted_at,
    to_char(timestamp '2023-03-05 15:13:35.612072+00:00', 'YYYY-MM-DD HH24:MI:SS')::timestamp im_opioid_stay_loaded_at,
