...
final as (
    ...
    select
        ...
        '3749258b-3909-47c2-bc5b-edb0b79ebfc4' as rv_hh_unity_golf_club__members_job_id,
        'circleci' as rv_hh_unity_golf_club__members_job_user_id,
        'default' as rv_hh_unity_golf_club__members_jira_task_key,
        to_char(timestamp '2023-05-07 19:40:26.907844+00:00', 'YYYY-MM-DD HH24:MI:SS')::timestamp   as rv_hh_unity_golf_club__members_extracted_at,
        to_char(timestamp '2023-05-07 19:40:26.907844+00:00', 'YYYY-MM-DD HH24:MI:SS')::timestamp  as rv_hh_unity_golf_club__members_loaded_at,
