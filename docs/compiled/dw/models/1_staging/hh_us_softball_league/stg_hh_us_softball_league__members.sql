...
final as (
    ...
    select
        ...
        '7aff3c53-f4b7-4d61-b4bf-0d43d20f97b0' as rv_hh_us_softball_league__members_job_id,
        'circleci' as rv_hh_us_softball_league__members_job_user_id,
        'default' as rv_hh_us_softball_league__members_jira_task_key,
        to_char(timestamp '2023-05-07 19:52:53.314653+00:00', 'YYYY-MM-DD HH24:MI:SS')::timestamp   as rv_hh_us_softball_league__members_extracted_at,
        to_char(timestamp '2023-05-07 19:52:53.314653+00:00', 'YYYY-MM-DD HH24:MI:SS')::timestamp  as rv_hh_us_softball_league__members_loaded_at,
