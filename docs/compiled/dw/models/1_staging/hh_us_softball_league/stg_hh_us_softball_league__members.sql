...
final as (
    ...
    select
        ...
        '056a736c-0a66-482a-8bea-9cf677869cab' as rv_hh_us_softball_league__members_job_id,
        'circleci' as rv_hh_us_softball_league__members_job_user_id,
        'default' as rv_hh_us_softball_league__members_jira_task_key,
        to_char(timestamp '2023-05-07 19:10:11.886586+00:00', 'YYYY-MM-DD HH24:MI:SS')::timestamp   as rv_hh_us_softball_league__members_extracted_at,
        to_char(timestamp '2023-05-07 19:10:11.886586+00:00', 'YYYY-MM-DD HH24:MI:SS')::timestamp  as rv_hh_us_softball_league__members_loaded_at,
