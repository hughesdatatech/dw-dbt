...
final as (
    ...
    select
        ...
        'dcb601de-b39f-4733-a1b9-29ff8c82de68' as rv_hh_us_softball_league__members_job_id,
        'circleci' as rv_hh_us_softball_league__members_job_user_id,
        'default' as rv_hh_us_softball_league__members_jira_task_key,
        to_char(timestamp '2023-05-07 20:19:17.787862+00:00', 'YYYY-MM-DD HH24:MI:SS')::timestamp   as rv_hh_us_softball_league__members_extracted_at,
        to_char(timestamp '2023-05-07 20:19:17.787862+00:00', 'YYYY-MM-DD HH24:MI:SS')::timestamp  as rv_hh_us_softball_league__members_loaded_at,
