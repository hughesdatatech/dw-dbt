...
final as (
    ...
    select
        ...
        '10828c61-cb2d-4d4b-8dd3-2a13bac161f7' as rv_hh_us_softball_league__members_job_id,
        'circleci' as rv_hh_us_softball_league__members_job_user_id,
        'default' as rv_hh_us_softball_league__members_jira_task_key,
        to_char(timestamp '2023-05-07 19:59:41.933416+00:00', 'YYYY-MM-DD HH24:MI:SS')::timestamp   as rv_hh_us_softball_league__members_extracted_at,
        to_char(timestamp '2023-05-07 19:59:41.933416+00:00', 'YYYY-MM-DD HH24:MI:SS')::timestamp  as rv_hh_us_softball_league__members_loaded_at,
